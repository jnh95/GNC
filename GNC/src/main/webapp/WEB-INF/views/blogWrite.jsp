...
<input style="display:none;" id="myBlog" name="myBlog" value="<%=memNo %>">
	...
	<div style="margin: 0 0 0 250px;">
		<div class="w3-content w3-padding"
			...
			<p class="w3-left"
				style="font-size: 20px; padding: 8px 16px 8px 16px; margin: 20px 0 10px 0;">블로그 작성하기</p>
			...
			<div class="w3-row-padding">
					<form method="get">
						...
						<div style="padding:10px;">
						<input id="content" placeholder="내용을 입력해주세요." style="width:1200px; height:1000px;">
						</div>
						...
						<button class="w3-button w3-right" style="border:1px solid #000; border-radius: 20px;">작성하기</button>
					</form>
			</div>
		</div>
	</div>
